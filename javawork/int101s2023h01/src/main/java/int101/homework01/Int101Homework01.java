...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
       System.out.println("BMI: " + MyUtill.calculateBMI(60, 1.65));
       System.out.println("AVG: " + MyUtill.average(3, 4, 5));
   ...
   static void work04UseOfObjectClass() {
       ...
       BankAccount bank1 = new BankAccount(123,person1);
       BankAccount bank2 = new BankAccount(456,person2);
       
       System.out.println("Person1 ID" + person1.getId());
        bank1.deposit(500);
        System.out.println("bank1 Updated Account Balance after Deposit: " + bank1.getBalance());
        bank1.withdraw(250);
        System.out.println("bank1 Updated Account Balance after Withdraw: " + bank1.getBalance());
        System.out.println("Person2 ID" + person2.getId());
        bank2.deposit(750);
        System.out.println("bank2 Updated Account Balance after Deposit: " + bank2.getBalance());
        bank2.withdraw(350);
        System.out.println("bank2 Updated Account Balance after Withdraw: " + bank2.getBalance());
        
        System.out.println("####Update balance####");
        bank1.transfer(50, bank2);
        System.out.println("Bank1 Updated Account Balance after trasnfer: " + bank1.getBalance());
        System.out.println("Bank2 Updated Account Balance after trasnfer: " + bank1.getBalance());
